...
func MakeAuthRouter(connPostgres *postegres.Postgres, log commons.Logger, prometheus adapter.Prometheus, conf *configs.Configs, tracer adapter.Tracer) *routes.LoginRoutes {
